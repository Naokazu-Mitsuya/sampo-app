  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ContentsRecord>>(
      stream: queryContentsRecord(
        queryBuilder: (contentsRecord) => contentsRecord.orderBy('time_stamp'),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<ContentsRecord> homeContentsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final homeContentsRecord = homeContentsRecordList.isNotEmpty
            ? homeContentsRecordList.first
            : null;
                                                            ...
                                                            children: [
                                                              StreamBuilder<
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  final toggleIconContentsRecord = toggleIconContentsRecordList
                                                                          .isNotEmpty
                                                                      ? toggleIconContentsRecordList
                                                                          .first
                                                                      : null;
                                                                  return ToggleIcon(
                                                                    onPressed:
                                                                      ...
                                                                      final likesUpdate = toggleIconContentsRecord!
                                                                              .likes
                                                                              .contains(
                                                                                  likesElement)
                                                                          ? FieldValue
                                                                      ...
                                                                      await toggleIconContentsRecord!
                                                                          .reference
                                                                          .update({
                                                                        'likes':
                                                                            likesUpdate,
                                                                    ...
                                                                    value: toggleIconContentsRecord!
                                                                        .likes
                                                                        .contains(
                                                                            currentUserReference),
                                                                    onIcon:
