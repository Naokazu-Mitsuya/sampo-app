...
import 'contents_details_model.dart';
export 'contents_details_model.dart';

class ContentsDetailsWidget extends StatefulWidget {
  const ContentsDetailsWidget({
    Key? key,
    required this.contentsRef,
  }) : super(key: key);

  final DocumentReference? contentsRef;

  @override
  _ContentsDetailsWidgetState createState() => _ContentsDetailsWidgetState();
}

class _ContentsDetailsWidgetState extends State<ContentsDetailsWidget> {
  late ContentsDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContentsDetailsModel());
  }
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: wrapWithModel(
                              model: _model.reactionSliderModel,
                              updateCallback: () => setState(() {}),
                              child: ReactionSliderWidget(
                                reactions:
                                    contentsDetailsContentsRecord.reactions,
                                contentRef:
                                    contentsDetailsContentsRecord.reference,
                              ),
                            ),
                          ),
                        ],
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        if (confirmDialogResponse) {
                                          await widget.contentsRef!.delete();
