  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ContentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ContentsRecord> editPostContentsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final editPostContentsRecord = editPostContentsRecordList.isNotEmpty
            ? editPostContentsRecordList.first
            : null;
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              controller: _model.titleController ??=
                                ...
                                text: editPostContentsRecord?.title,
                              ),
                              autofocus: true,
                              obscureText: false,
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              controller: _model.descriptionController ??=
                                  TextEditingController(
                                text: editPostContentsRecord?.description,
                              ),
                              autofocus: true,
                              obscureText: false,
                              decoration: InputDecoration(
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                await editPostContentsRecord!.reference
                                    .update(createContentsRecordData(
                                  title: _model.titleController.text,
                                  description:
                                      _model.descriptionController.text,
                                  photoUrl: editPostContentsRecord?.photoUrl,
                                ));
